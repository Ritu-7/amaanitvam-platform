...
export default class ProgramsHero {
  render() {
    return `
      <section id="programs-hero" class="relative py-36 bg-stone-50 overflow-hidden flex items-center justify-center select-none border-b border-stone-200/50 z-10 pt-44">
        ...
        <div class="max-w-4xl mx-auto px-6 text-center relative z-10">
          <div class="flex flex-col items-center stagger-container">
            ...
            <!-- Legible Subtitle -->
            <p class="type-section-description max-w-2xl mb-10 stagger-load">
            ...
            <div class="flex flex-wrap items-center justify-center gap-4 stagger-load">
              <a href="#ecosystem" class="inline-flex items-center gap-2 font-interface font-semibold text-[11px] uppercase tracking-widest px-8 py-4 rounded-md bg-gold-satin text-white hover:bg-gold-satin/95 shadow-sm transition-all duration-300">
                Explore Programs
              </a>
              <a href="${PATHS.VOLUNTEER}" class="inline-flex items-center gap-2 font-interface font-semibold text-[11px] uppercase tracking-widest px-8 py-4 rounded-md border border-stone-200 text-stone-600 bg-white hover:border-pink-ruby hover:text-pink-ruby transition-all duration-300">
                Get Involved
              </a>
            </div>
