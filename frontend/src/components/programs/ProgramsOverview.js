export default class ProgramsOverview {
  render() {
    return `
      <section id="ecosystem" class="relative py-28 bg-stone-50/50 overflow-hidden border-t border-b border-stone-200/20 z-20 select-none scroll-mt-24">
        ...
        <div class="max-w-6xl mx-auto px-6 relative z-10 text-center">
          ...
          <div class="flex flex-col items-center justify-center relative select-none stagger-container max-w-lg mx-auto py-8 bg-white border border-stone-200/50 rounded-2xl shadow-sm hover:shadow-md transition-shadow duration-500">
            ...
            <div class="relative flex flex-col items-center mb-6 stagger-load z-10">
              <a href="#program-manthan" aria-label="Scroll to Project Manthan details" class="px-6 py-2.5 rounded-md bg-white border-2 border-pink-ruby text-pink-ruby font-interface text-xs uppercase font-bold tracking-widest shadow-sm hover:scale-103 hover:border-pink-ruby/80 hover:text-pink-ruby/80 transition-all duration-300 cursor-pointer block focus:outline-none focus:ring-2 focus:ring-pink-ruby focus:ring-offset-2">Project Manthan</a>
            </div>
            ...
            <div class="relative flex flex-col items-center mb-6 stagger-load z-10">
              <a href="#program-shiksha" aria-label="Scroll to Project Shiksha details" class="px-6 py-2.5 rounded-md bg-white border-2 border-amber-500 text-amber-600 font-interface text-xs uppercase font-bold tracking-widest shadow-sm hover:scale-103 hover:border-amber-500/80 hover:text-amber-600/80 transition-all duration-300 cursor-pointer block focus:outline-none focus:ring-2 focus:ring-amber-500 focus:ring-offset-2">Project Shiksha</a>
            </div>
            ...
            <div class="relative flex flex-col items-center mb-6 stagger-load z-10">
              <a href="#program-pravah" aria-label="Scroll to Project Pravah details" class="px-6 py-2.5 rounded-md bg-white border-2 border-pink-ruby text-pink-ruby font-interface text-xs uppercase font-bold tracking-widest shadow-sm hover:scale-103 hover:border-pink-ruby/80 hover:text-pink-ruby/80 transition-all duration-300 cursor-pointer block focus:outline-none focus:ring-2 focus:ring-pink-ruby focus:ring-offset-2">Project Pravah</a>
            </div>
