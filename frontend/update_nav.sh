...
for file in volunteer.html internship.html verify.html updates.html events.html impact.html gallery.html resources.html faq.html guidelines.html circulars.html index_backup.html; do
  if [ ! -f "$file" ]; then
    continue
  fi
